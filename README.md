...
## Abstract
Collegiate EMS agencies staff event dispatch with EMTs who lack formal training... [Truncated for brevity, paste your full abstract here].

## Repository Structure
* `/assets`: Contains the SVG version of the poster for web viewing.
* `/pdf`: Contains the high-resolution PDF for printing.
* `/figures`: Individual charts and data visualizations used in the study.
